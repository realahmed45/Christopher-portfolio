...
// Navbar background on scroll with better effect
...
// Observe all project cards and principle cards with initial hidden state
document
  .querySelectorAll(".project-card, .principle-card, .skill-card")
  .forEach((el) => {
    el.style.opacity = "0";
